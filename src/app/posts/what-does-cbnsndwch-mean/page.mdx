...
export const post = {
    author: 'Sergio Leon',
    date: '2024-01-12',
    title: 'What does "cbnsndwch" mean?',
    description: "It's not super obvious, I know.",
};
...
import cbnsndwchPic from './the-og-sandwich-of-south-florida.jpg';

export default function (props) {
    return <PostLayout post={post} {...props} />;
}

<Image src={cbnsndwchPic} alt="the OG sandwich of south florida" />
