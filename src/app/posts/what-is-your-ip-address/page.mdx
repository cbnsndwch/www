...
import coverPic from './ipv4-ipv6.jpg';

export default function (props) {
    return <PostLayout post={post} {...props} />;
}

<Image src={coverPic} alt="the OG sandwich of south florida" />
<small><em>
    <a href="https://www.flickr.com/photos/140988606@N08/28953519841" nofollower noreferrer>
        📸 by Christoph Scholz
    </a>
</em></small>
