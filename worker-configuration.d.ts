/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: e3c5e8adf3b5bd6ef89604da02b9fd7a)
// Runtime types generated with workerd@1.20260921.1 2026-09-21 nodejs_compat
interface __BaseEnv_Env {
    NEXT_PUBLIC_SITE_URL: string;
    NEXT_PUBLIC_ENGAGEMENT_WIDGET_ID: string;
    NEXT_TELEMETRY_DISABLED: string;
    NEXT_PUBLIC_CALENDAR_LINK: string;
    PRIVATE_GHL_MCP_LOCATION_ID: string;
    PRIVATE_GHL_MCP_PIT: string;
    PRIVATE_GHL_MCP_CUSTOM_FIELDS_FOLDER_ID: string;
    PRIVATE_X_API_KEY: string;
}
...
declare namespace NodeJS {
    interface ProcessEnv extends StringifyValues<
        Pick<
            ...
            | 'NEXT_PUBLIC_ENGAGEMENT_WIDGET_ID'
            | 'NEXT_TELEMETRY_DISABLED'
            | 'NEXT_PUBLIC_CALENDAR_LINK'
            | 'PRIVATE_GHL_MCP_LOCATION_ID'
            | 'PRIVATE_GHL_MCP_PIT'
            | 'PRIVATE_GHL_MCP_CUSTOM_FIELDS_FOLDER_ID'
            | 'PRIVATE_X_API_KEY'
        >
    > {}
}
...
declare abstract class BrowserRun {
    ...
    acquire(
        options?: BrowserRunAcquireOptions
